...
public class PredefinedStepDefs {
    ...
    @Given("I print variables {string} and {string}")
    public void iPrintVariablesAnd(String arg0, String arg1) {
    }

    @And("I print variable uppercase")
    public void iPrintVariableUppercase() {
        System.out.println();
    }
}
